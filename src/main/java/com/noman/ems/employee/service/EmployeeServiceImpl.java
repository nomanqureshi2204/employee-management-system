...
public class EmployeeServiceImpl implements EmployeeService {
	...
	public Employee getEmployeeByEmail(String email) {
		return employeeRepo.findByEmail(email)
				.orElseThrow(() -> new ResourceNotFoundException("Empoyee not found with email: " + email));
	}
	...
	public Employee assignEmployeeToProject(String empId, String projectId) {
		Employee emp = employeeRepo.findById(empId).orElseThrow(() -> new ResourceNotFoundException("Employee not found"));
	...
	public String login(String email,String password) {
		...
		if(passwordEncoder.matches(password, emp.getPassword())) {
			...
			UsernamePasswordAuthenticationToken auth = 
					new UsernamePasswordAuthenticationToken(emp.getEmail(),
							null,Collections.
							singleton(new SimpleGrantedAuthority(emp.getRole())));
